...
class TarefaPrefDAO (val context: Context){

    companion object{
        private var controleIndice = 0;

        fun getInstance(context: Context) : TarefaPrefDAO {
            return TarefaPrefDAO(context)
        }
    }

    private fun getSharedPreferences(): SharedPreferences{
        return context.getSharedPreferences(UsuarioPrefDAO.PREFERENCE_USERS, Context.MODE_PRIVATE)
    }
